...
expected_values(::MultinomialLogisticLoss) = [2.12693, 4.01815, 0.693147]-fv
expected_derivs(::MultinomialLogisticLoss) = [0.88079, 0.98201,-0.5]
...
for loss in multinomialLosses
    ...
    # check derivatives
    @test_approx_eq_eps derivs(loss, fv_mul, y_mul) y+expected_derivs(loss) eps
end